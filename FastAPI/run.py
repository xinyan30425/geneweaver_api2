...
# from coronavirus.main import application
...
# static_dir = 'FastAPI/coronavirus/static'
static_dir = os.path.join(os.path.dirname(__file__), 'coronavirus', 'static')

print(static_dir)  # Print out the absolute path to verify it's correct.
